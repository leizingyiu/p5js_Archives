...
class KeyboardCtrl {
	...
	keyPressedDetector(str, separator = this.keySeparator) {
		...
		// console.trace();
		// console.log('keyDetector  ', str, keyCodeArr, this.keyPressedList_runTime);
	...
	main() {
		...
		if (keyIsPressed === true) {
			...
			Object.keys(this.keyHoldingList).map(i => {
				// console.log(i, this.keyPressedDetector(i));
			...
			// console.log(this.keyHoldingList, this.keyPressedList_runTime, this.keyPressedList_realTime);
		}
