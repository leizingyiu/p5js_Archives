...
musics = [
    "https://www.openprocessing.org/sketch/1454055/files/0__edm-13416_freepd_com_64kbps.mp3",
    "https://www.openprocessing.org/sketch/1454055/files/0__edm-13416_freepd_com_128kbps.mp3",
    "https://www.openprocessing.org/sketch/1454055/files/0__Quick Metal Riff 1_freepd_com.mp3",
    "https://www.openprocessing.org/sketch/1454055/files/0__Bit Bit Loop_freepd_com_64kbps.mp3"
]
    ;
...
// au = document.createElement('audio');    au.controls = 'true';  au.preload = 'true';  au.loop = 'true'; 
...
function preload() {
    titleFont = loadFont('https://fonts.cdnfonts.com/s/74329/Xhers Regular.woff', redraw);
    fontOfText = loadFont('https://fonts.cdnfonts.com/s/19712/NimbusSanL-Regu.woff', redraw);
}
function setup() {
    ...
    // gainNode.connect(p5.soundOut);




    // let auE=new p5.MediaElement(au);
    //     amplitude.setInput(auE);
    //   fft.setInput(auE);
